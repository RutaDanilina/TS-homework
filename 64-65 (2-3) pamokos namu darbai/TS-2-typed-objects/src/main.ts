...
const isFullyDescribedPerson = (heightAndWeight : Person): boolean => Boolean(heightAndWeight.height && heightAndWeight.weight);
...
const createInitials = (personInitials: Person) => `${personInitials.name[0]}. ${personInitials.surname[0]}.`;
