...
const isFullyDescribedPerson = (heightAndWeight) => Boolean(heightAndWeight.height && heightAndWeight.weight);
console.log({
...
const createInitials = (personInitials) => `${personInitials.name[0]}. ${personInitials.surname[0]}.`;
console.log({
